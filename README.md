...
- **Review policy is optional.** Adopting repositories can supply additional project rules in a root `REVIEW.md`. This repository uses the skill defaults and applicable repository instructions and configuration without a separate review policy file.
