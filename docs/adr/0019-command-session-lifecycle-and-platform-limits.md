...
- Tickets #154 through #158 remain pending behavior work. Until each merges, the affected seam leaves describe current shipped behavior; this ADR records the accepted target, not shipped changes.
