...
15. **INV-15** — Requirements revision (SHA-256): evidence carries the value; PR publication compares current bodies; mismatch stops with `needs-info`; comments never enter the fingerprint. A missing pin never counts as current.
...
Glossary: `CONTEXT.md`. Decisions: ADR-0014, 0015, 0019, 0021, 0023, 0024, 0031, 0032, 0034. Review policy: `REVIEW.md` (optional). Redirect: `docs/leaves/ext/implement-this.md`.
