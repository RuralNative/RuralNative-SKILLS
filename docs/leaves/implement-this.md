...
11. **INV-11** — Completion: `/review-this #<spec>` from the control workspace; worktrees do not run review.
...
Glossary: `CONTEXT.md`. Decisions: ADR-0014, 0015, 0019, 0021, 0023. Review policy: `REVIEW.md`. Redirect: `docs/leaves/ext/implement-this.md`.