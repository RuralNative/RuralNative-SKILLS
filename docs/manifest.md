...
| document-for-humans | skills/document-for-humans/ | sha256:5fbcfdf43c760f12266e9984c6935f0aff0318f8605e59154f43b04f47d0fcc6 | 2026-09-16 | Task-oriented task guides, operation references, and developer recipes with applicability checks; operational-state separation with permission-compatible recovery; content-aware maintenance with shared-dependents and metadata-only rejection; five-kind evidence separation with honest contexts and semantic recheck; reporting limits and frozen synthetic comparison fixtures; claims reviewed against current code |
