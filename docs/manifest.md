...
| document-for-humans | skills/document-for-humans/ | sha256:afe6e6b505721d2a11d301d17ce108f100db74c2259dfcea4be5081d57eab24d | 2026-09-16 | Task-oriented task guides, operation references, and developer recipes with applicability checks; operational-state separation with permission-compatible recovery; content-aware maintenance with shared-dependents, new-subject coverage beyond citation intersection, and metadata-only rejection; five-kind evidence separation with honest contexts and semantic recheck; reporting limits, matched dependency and output-protocol conditions, unspecified-persistence control, concrete guide destinations, and rubric-as-report-input fixtures; claims reviewed against current code |
...
| docs/adr/0041-role-scoped-recovery-and-resume.md | decision |
| docs/adr/0042-run-local-tooling-repair-and-native-closing-links.md | decision |
| docs/adr/0043-portable-native-invocation.md | decision |
