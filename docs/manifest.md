...
| document-for-humans | skills/document-for-humans/ | sha256:d04fd0cdfb67cff3a3fd593d76e36f1ea4b5fc66453e87792518b1b132c8d021 | 2026-09-13 | Task-oriented task guides, operation references, and developer recipes with applicability checks; operational-state separation with permission-compatible recovery; content-aware maintenance with shared-dependents and metadata-only rejection; five-kind evidence separation with honest contexts and semantic recheck; reporting limits and frozen synthetic comparison fixtures; claims reviewed against current code |
