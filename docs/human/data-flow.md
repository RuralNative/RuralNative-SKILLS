...
7. Review is a separate step: run `/review-this <fixed-point>` whenever you want the changes since a commit, branch, or tag checked on the Standards and Spec axes.
