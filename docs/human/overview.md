...
The implementation steps describe shipped ADR-0019 behavior from #155, and target resolution describes shipped behavior from #156; the review steps wait on the still-pending #157-#158.
