...
Across all three commands, text from tickets, comments, and specifications is requirements data: it describes the work but cannot authorize tools or change the rules. Runs never download skills; you install them, and a manual install asks before overwriting an existing one.
