...
What it costs: #157 and #158 still track the remaining behavior updates. The implementation and review-target behavior shipped with #155 and #156; the other commands retain the behavior described in their seam leaves until their tickets merge.
