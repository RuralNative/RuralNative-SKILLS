...
### 2026-08-23 - Run the workflow through independent command sessions (accepted; behavior pending)
...
What it costs: the behavior updates are tracked by tickets #154-#158. Until each merges, the current commands retain the shipped behavior described in their seam leaves; this entry records the accepted target, not a shipped implementation.
