...
Use explicit scope: named files, ranges, or changed prose the caller provides.
Do not choose files on your own.
...
In this baseline, the skill works on prose you explicitly provide. It preserves
meaning, evidence, and certainty, and it does not rewrite code, commands,
frontmatter, links, quotations, citations, names, numbers, dates, units, or
glossary terms unless you include them in scope. Non-English passages remain
unchanged.
...
- `reference/parity.md` — parity catalog mapping upstream rules 1..31 to local `AIT-*` identifiers.
